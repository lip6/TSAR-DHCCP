...
proctype proc (chan PL1DTREQ, L1PDTACK,OBSREQX,OBSACKX,OBSREQY,OBSACKY, OBSRDX,OBSACKRDX,OBSRDY,OBSACKRDY){
...
proctype proc_rd(chan PL1DTREQ, L1PDTACK, OBSREQRDWR,OBSACKRDWR, OBSREQRDRD, OBSACKRDRD; bit addr) {
...
proctype proc_rd_wr(chan PL1DTREQ, L1PDTACK, OBSREQRDWR,OBSACKRDWR, OBSREQRDRD, OBSACKRDRD ; bit addr) {
